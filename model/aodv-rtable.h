...
public:
  ...
  float computeBelief (int pos, int neg) {
	  float belief;
  ...
  float computeDisbelief (int pos, int neg) {
	  float disbelief;
  ...
  float computeUncertainty (int pos, int neg) {
	  float uncertainty;
  ...
  void SetPositiveEvents (int pos) {m_pos = pos; }
  int GetPositiveEvents () const { return m_pos; }
  void SetNegativeEvents (int neg) {m_neg = neg; }
  int GetNegativeEvents () const { return m_neg; }
  void SetBelief (float bel) {m_bel = bel;} 
  float GetBelief () const {return m_bel;} 
  void SetDisbelief (float disbel) {m_disbel = disbel;} 
  float GetDisbelief () const {return m_disbel;} 
  void SetUncertainty (float unc) {m_unc = unc;} 
  float GetUncertainty () const {return m_unc;} 
  /// RREP_ACK timer
  Timer m_ackTimer;
...
public:
  ...
  /// Update trust values
  void UpdateTrustValues (RoutingTableEntry & rt);
  /**
