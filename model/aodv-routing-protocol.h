...
private:
  ...
  */
  ...
  //Hash
  uint32_t HashMHCTimes (uint32_t hash, int total);
  
  //RecvRequestDSE
  void RequestDSE (Ipv4Address src, Ipv4Address destination, uint32_t hopcount);
  
  //SendRequestDSE
  void SendRequestDSE (Ptr<Packet> p, Ipv4Address src, Ipv4Address destination);
  
  //RecvRequestDSE
  void RecvRequestDSE (Ptr<Packet> p, Ipv4Address address);
  
  //CheckHash
  bool CheckHash (RreqDSE *rreqDSE, RrepHeader *rrepHeader);
